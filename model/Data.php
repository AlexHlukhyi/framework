...
abstract class Data {
    ...
    public function readStudents($groupId) {
        if ($this->user->checkRight('student', 'view')) {
            ...
            $this->error = "You don't have permissions to view students.";
            return false;
        }
    }
    ...
    public function readStudent($groupId, $id) {
        if($this->checkRight('student', 'view')) {
            ...
            $this->error = "You don't have permissions to view student.";
            return false;
        }
    }
    ...
    public function readGroups() {
        if ($this->checkRight('group', 'view')) {
            ...
            $this->error = "You don't have permissions to view groups.";
            return false;
        }
    }
    ...
    public function readGroup($id) { 
        if($this->checkRight('group', 'view')) {
            ...
            $this->error = "You don't have permissions to view group.";
            return false;
        }
    }
    ...
    public function readUsers() {
        if($this->checkRight('user', 'admin')) {
            ...
            $this->error = "You don't have permissions to administrate users.";
            return false;
        }
    }
    ...
    public function writeStudent(Student $student) {
        if($this->checkRight('student', 'edit')) {
            ...
            $this->error = "You don't have permissions to edit students.";
            return false;
        }
    }
    ...
    public function writeGroup(Group $group) {
        if($this->checkRight('group', 'edit')) {
            ...
            $this->error = "You don't have permissions to edit groups.";
            return false;
        }
    }
    ...
    public function removeStudent(Student $student) {
        if($this->checkRight('student', 'delete')) {
            ...
            $this->error = "You don't have permissions to delete students.";
            return false;
        }
    }
    ...
    public function addStudent(Student $student) {
        if($this->checkRight('student', 'create')) {
            ...
            $this->error = "You don't have permissions to create students.";
            return false;
        }
    }
    ...
    public function removeGroup($groupId) {
        if($this->checkRight('group', 'delete')) {
            ...
            $this->error = "You don't have permissions to delete groups.";
            return false;
        }
    }
    ...
    public function addGroup() {
        if($this->checkRight('group', 'create')) {
            ...
            $this->error = "You don't have permissions to create groups.";
            return false;
        }
    }
