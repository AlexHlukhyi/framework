    ...
    private function showGroup(\Model\Group $group) {
        ...
        <div class="container group-info">
            <div class="row text-center">
                <h2 class="col-xs-12">Список групи <span class='text-primary'>
                    <?php echo $group->getNumber(); ?>
                </span></h1>
                <h3 class="col-xs-12">Староста: <span class='text-danger'>
                    <?php echo $group->getStarosta(); ?>
                </span></h2>
                <h3 class="col-xs-12">Факультет <span class='text-success'>
                    <?php echo $group->getDepartment(); ?>
                </span></h3>
                <div class='group-control col-xs-12'>
        ...
        <section class="container students">
            ...
            <?php if($_GET['group']): ?>
                ...
                <form name='students-filter' method='post'>
                    ...
                    <div class="col-xs-3">
                        <input class="btn btn-info" type="submit" value="фільтрувати">
                    </div>
                </form>
                </div>
            </div>
                ...
                <table class="table col-xs-12">
                    <thead>
                        <tr>
                            ...
                            <?php if($this->checkRight('student', 'edit') || $this->checkRight('student', 'delete')): ?>
                            <th>Редагування</th>
                            <?php endif; ?>
                        </tr>
                    </thead>
    ...
    public function showMainForm($groups, \Model\Group $group, $students) {
        ?>
            ...
            <head>
                ...
                <link rel="stylesheet" href="<?php echo self::ASSETS_FOLDER; ?>css/main.css">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-4">
                        <form name='edit-group' method='post' action="?action=edit-group&group=<?php echo $_GET['group']; ?>">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="number" value="<?php echo $group->getNumber(); ?>">
                            </div>
                            <div class="form-group">
                                <label for='starosta'>Староста: </label>
                                <input class="form-control" type="text" name="starosta" value="<?php echo $group->getStarosta(); ?>">
                            </div>
                            <div class="form-group">
                                <label for='department'>Факультет: </label>
                                <input class="form-control" type="text" name="department" value="<?php echo $group->getDepartment(); ?>">
                            </div>
                            <button class="btn btn-success pull-right" type="submit">Змінити</button>
                            <a class="btn btn-info btn-sm pull-left" href="index.php?group=<?php echo $_GET['group']; ?>">На головну</a>
                        </form>
                    </div>
                </div>
            </div>
    ...
    public function showStudentEditForm(\Model\Student $student) {
        ?>
            ...
            <head>
                ...
                <meta charset="UTF-8">
                <link rel="stylesheet" href="<?php echo self::ASSETS_FOLDER; ?>css/bootstrap.min.css">
                <link rel="stylesheet" href="<?php echo self::ASSETS_FOLDER; ?>css/checkbox.css">
                <script src="<?php echo self::ASSETS_FOLDER; ?>js/jquery.min.js"></script>
                <script src="<?php echo self::ASSETS_FOLDER; ?>js/bootstrap.min.js"></script>
            </head>
            <body>
                        ...
                        <form name='edit-student' method='post' action="?action=edit-student&file=<?php echo $_GET['file']; ?>&group=<?php echo $_GET['group']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="stud_gender">
                                    ...
                                    <option <?php echo ("чол" == $student->isGenderMale())?"selected":""; ?> value="чол">Чоловіча</option>
                                    <option <?php echo ("жін" == !$student->isGenderMale())?"selected":""; ?> value="жін">Жіноча</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" <?php echo ("1" == $student->isPrivilege())?"checked":""; ?> name="stud_privilege" value="1"> бюджетник
                                </label>
                            </div>
    ...
    public function showStudentCreateForm() {
        ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-4">
                        <form name='create-student' method='post' action="?action=create-student&file=<?php echo $_GET['file']; ?>&group=<?php echo $_GET['group']; ?>">
                            <div class="form-group">
                                <label for='stud_name'>Прізвище: </label>
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="stud_privilege" value="1"> бюджетник
                                </label>
                            </div>
                            <button type="submit" class="btn btn-success pull-right">Додати</button>
                            <a class="btn btn-info btn-sm pull-left" href="index.php?group=<?php echo $_GET['group']; ?>">На головну</a>
                        </form>
                    </div>
                </div>
        ...
        ?>
            ...
            <body>
                ...
                <div class="row table-users">
                    <table class="table col-sm-6 col-md-4 col-lg-3">
                        <thead>
                            <tr>
                                <th>Користувач</th>
                            </tr>
                            ...
                            <?php foreach($users as $user): ?>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a class="btn btn-primary btn-xs pull-right" href="?action=edit-user-form&username=<?php echo $user->getUserName();?>">Редагувати</a>
                                    </td>
                                </tr> 
                                <?php endif; ?>
                            <?php endforeach; ?>
                ...
                <a class="btn btn-info btn-sm pull-left" href="index.php">На головну</a>
                </section>
            </body>
            </html>
        <?php
    ...
    public function showUserEditForm(\Model\User $user) {
        ?>
            ...
            <head>
                ...
                <link rel="stylesheet" href="<?php echo self::ASSETS_FOLDER; ?>css/bootstrap.min.css">
                <link rel="stylesheet" href="<?php echo self::ASSETS_FOLDER; ?>css/checkbox.css">
                <link rel="stylesheet" href="<?php echo self::ASSETS_FOLDER; ?>css/user-edit.css">
                <script src="<?php echo self::ASSETS_FOLDER; ?>js/jquery.min.js"></script>
                <script src="<?php echo self::ASSETS_FOLDER; ?>js/bootstrap.min.js"></script>
            </head>
            <body>
                ...
                <form name='edit-user' method='post' action="?action=edit-user&user=<?php echo $_GET['user']; ?>">
                    ...
                    <div>
                        ...
                        <span> право адміністрування</span>
                    </div>
                    <a class="btn btn-info pull-left" href="?action=admin">До списку користувачів</a>
                    <button type="submit" class="btn btn-success edit-button">Змінити</button>
                </form>
                </section>
            </body>
            </html>
