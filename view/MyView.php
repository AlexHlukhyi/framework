...
class MyView extends GroupListView {
    ...
    private function showGroup(\Model\Group $group) {
        ?>
            <h1>Список групи <span class='group-number'>
                <?php echo $group->getNumber(); ?>
            </span></h1>
            <h2>Староста: <span class='group-starosta'>
                <?php echo $group->getStarosta(); ?>
            </span></h2>
            <h3>Факультет <span class='group-department'>
			...
			<section>
				<?php if($_GET['group']): ?>
					...
					<form name='students-filter' method='post'>
						Фільтрувати за прізвищем 
						<input type="text" name="stud_name_filter" value="<?php echo $_POST['stud_name_filter']; ?>">
            ...
            <body>
                ...
                <form name='edit-group' method='post' action="?action=edit-group&group=<?php echo $_GET['group']; ?>">
                    <div>
                        ...
                        <input type="text" name="number" value="<?php echo $group->getNumber(); ?>">
                    </div>
                    <div>
                        <label for='starosta'>Староста: </label>
                        <input type="text" name="starosta" value="<?php echo $group->getStarosta(); ?>">
                    </div>
                    <div>
                        <label for='department'>Факультет: </label>
                        <input type="text" name="department" value="<?php echo $group->getDepartment(); ?>">
                    </div>
                    <div>
        ...
        ?>
            ...
            <body>
                ...
                <form name='edit-student' method='post' action="?action=create-student&group=<?php echo $_GET['group']; ?>">
                    ...
                    <div>
                        <input type="checkbox" value=1> бюджетник
                    </div>
                    <div>
